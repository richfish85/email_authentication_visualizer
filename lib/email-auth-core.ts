...
export type LookupStatus = "ok" | "missing" | "timeout" | "error";
...
export function summarizeDmarc(
  lookup: TxtLookupResult,
  recordCount: number,
...
export function buildAnalysisFromTxtLookups({
  domain,
  dkimSelector,
  domainTxt,
  dmarcTxt,
  ...
  domain: string;
  dkimSelector?: string;
  domainTxt: TxtLookupResult;
  dmarcTxt: TxtLookupResult;
  dkimTxt: TxtLookupResult | null;
}): AnalysisResponse {
